        ...
        <div class="card shadow-card border-0 mb-3">
            <div class="card-body row">
                ...
                <div class="col-12 col-lg-10 col-lg-8">
                    <h5 class="text-center">{{ $title }} <span class="text-primary">in {{ $datas->menuGroup->name }}</span></h5>
                    <form method="POST"
                        ...
                        <div class="mx-auto d-flex justify-content-between mt-3">
                            <a href="{{ route('menu.read', ['id' => $datas->menu_group_id]) }}" class="btn btn-secondary">
